...
export default function About() {
  return (
    <div className="container">
      ...
      >
        occupation:{" "}
        <span style={{ color: "#18cebb" }}>"Full-stack web developer"</span>
        <br />
        techStack:{" "}
        <span style={{ color: "#18cebb" }}>[React, JS, RoR, Ruby, Redux]</span>
        <br />
        likes: <span style={{ color: "#18cebb" }}>[Code, Dogs, Coffee]</span>
        <br />
      </div>
